 ...
 */
const WEBSITE_ROUTES = ['/', '/product', '/events', '/notifications', '/crm', '/pricing', '/journal', '/terms', '/privacy', '/whatsapp-migration', '/telegram-backup', '/agencies', '/events-organizers', '/demo', '/partners', '/docs']
