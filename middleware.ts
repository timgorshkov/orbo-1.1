 ...
 */
const WEBSITE_ROUTES = ['/', '/product', '/events', '/notifications', '/crm', '/pricing', '/journal', '/terms', '/privacy', '/requisites', '/agent-agreement', '/whatsapp-migration', '/telegram-backup', '/agencies', '/events-organizers', '/demo', '/partners', '/docs']
...
export const config = {
  matcher: [
     ...
     */
    '/((?!_next/static|_next/image|favicon.ico|api/telegram/import-history).*)',
  ],
}
