-- Migration 078: Fix sync_telegram_admins - remove user_telegram_account_id references
-- Created: 2025-11-01
-- Purpose: Remove references to user_telegram_account_id (deleted in migration 071)
  ...
  FOR v_admin_record IN (
    ...
    IF v_user_id IS NOT NULL THEN
      ...
      IF v_participant IS NULL THEN
        -- ✅ Создаём participant, если его нет
    ...
    ELSE
      ...
      IF v_participant IS NULL THEN
        -- ✅ Создаём participant из данных group admin
...
COMMENT ON FUNCTION sync_telegram_admins IS 'Sync admin roles from Telegram groups. Auto-creates participants if needed. FIXED: removed user_telegram_account_id references.';

-- Verify
DO $$
BEGIN
  RAISE NOTICE '=== Migration 078 Complete ===';
  RAISE NOTICE 'Fixed sync_telegram_admins function';
  RAISE NOTICE 'Removed user_telegram_account_id references';
  RAISE NOTICE '================================';
END $$;
