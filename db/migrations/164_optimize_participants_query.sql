-- Migration 164: Optimize participants query for /members page
-- Date: 2025-12-20
-- Problem: Page makes 10+ sequential queries, loads ALL messages
-- Solution: Create optimized RPC function

-- Function to get participants with all enrichment in ONE query
...
COMMENT ON FUNCTION get_enriched_participants IS 
'Optimized function for /members page - returns participants with roles, tags, and message stats in ONE query';

DO $$ BEGIN 
  RAISE NOTICE 'Migration 164 complete: Created get_enriched_participants function'; 
END $$;
