-- Migration 166: Fix enriched_at column in get_enriched_participants RPC
-- The enriched_at column doesn't exist in participants table - it's stored in custom_attributes
