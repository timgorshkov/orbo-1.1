...
-- Ошибка: relation "telegram_admins" does not exist
-- Проблема: миграция 40 использовала несуществующую таблицу telegram_admins
-- Решение: использовать правильную таблицу user_group_admin_status
...
COMMENT ON FUNCTION sync_telegram_admins IS 'Синхронизирует роли админов на основе статуса админа в Telegram группах (исправлено: используется user_group_admin_status)';
