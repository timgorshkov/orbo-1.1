-- Migration 214: Filter archived participants from engagement breakdown
-- Date: Jan 26, 2026
-- Purpose: Exclude archived participants from engagement statistics
...
BEGIN
  -- Get total participants in this org (exclude archived)
  ...
  -- Calculate real activity dates for each participant using JOINs (exclude archived)
...
DO $$ BEGIN RAISE NOTICE 'Migration 214 Complete: Filtered archived participants from engagement breakdown'; END $$;
