      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-start gap-2 text-xs text-gray-500 mt-1">
            <Info className="w-3.5 h-3.5 flex-shrink-0 mt-0.5" />
            <span>
              Telegram ограничивает выдачу участников до 10 000 на один поисковый запрос.
              Для групп с более чем 10 000 участников система автоматически перебирает буквы
              алфавита, чтобы загрузить максимум. Участники с именами на редких языках
              (китайский, арабский и т.д.) или с удалёнными аккаунтами могут не попасть в выгрузку.
            </span>
          </div>
        </CardContent>
      </Card>
