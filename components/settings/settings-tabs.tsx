...
export type SettingsTab = 'team' | 'general' | 'tags' | 'notifications' | 'event-emails' | 'billing' | 'portal' | 'payments' | 'finances' | 'contract' /* deprecated, redirects to payments */
...
const TABS = [
  ...
  { id: 'event-emails', label: 'Письма участникам' },
