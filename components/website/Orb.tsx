...
interface OrbProps {
  ...
  hue?: number;
  /** Intensity of hover distortion effect */
  hoverIntensity?: number;
  /** Whether to rotate on hover */
  rotateOnHover?: boolean;
  /** Force hover state (always show hover effect) */
...
/**
 * Orb background component from react-bits
 * https://github.com/DavidHDev/react-bits
 * 
 * Uses WebGL (OGL) for rendering animated gradient orb
 */
