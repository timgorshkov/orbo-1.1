...
export default function EventsPage() {
  return (
    <>
      ...
      {/* How to make an event - SEO text */}
      <section className="website-section website-section--alt">
        <div className="website-container">
          <div className="section-header section-header--center">
            <span className="section-header__eyebrow">Подробнее</span>
            <h2 className="section-header__title">Как сделать мероприятие в Telegram-группе</h2>
          </div>

          <div className="migration-faq">
            <div className="migration-faq__item">
              <h3>Как создать запись на мероприятие в Telegram?</h3>
              <p>
                Зарегистрируйтесь в Orbo, создайте событие (название, дата, место, описание),
                укажите стоимость участия, если оно платное. Orbo сгенерирует MiniApp с формой
                регистрации. Поделитесь ссылкой в группу — участники регистрируются прямо
                в Telegram, без перехода на внешний сайт. Данные из профиля подставляются
                автоматически — это повышает конверсию в регистрацию.
              </p>
            </div>

            <div className="migration-faq__item">
              <h3>Бот для записи на событие в Telegram</h3>
              <p>
                После создания события бот <strong>@orbo_event_bot</strong> может опубликовать
                анонс с обложкой и кнопкой «Зарегистрироваться» прямо в вашу Telegram-группу.
                Кнопка открывает MiniApp внутри Telegram — участнику не нужно открывать браузер.
                За 24 часа и за 1 час до начала бот отправит напоминание каждому
                зарегистрировавшемуся в личные сообщения. Это автоматические уведомления,
                которые повышают доходимость до мероприятия.
              </p>
            </div>

            <div className="migration-faq__item">
              <h3>Как собрать оплату за мероприятие?</h3>
              <p>
                При создании события укажите стоимость и ссылку на оплату (ЮKassa, Tinkoff, Stripe
                или любой другой сервис). Участник сначала заполняет форму регистрации, потом
                переходит к оплате. Orbo отслеживает статусы: «ожидает оплаты», «оплачено»,
                «частично», «просрочено». Никакого «скинь на Сбер» — профессиональный сбор оплаты
                с отчётностью по каждому участнику.
              </p>
            </div>

            <div className="migration-faq__item">
              <h3>Что происходит с данными после мероприятия?</h3>
              <p>
                Каждый зарегистрировавшийся участник остаётся в вашей CRM. В его карточке
                сохраняется история: на каких событиях был, сколько платил, как часто
                участвует. Это позволяет видеть, кто ваши самые ценные участники,
                и работать с ними точечно. Данные хранятся на российских серверах
                и доступны в любой момент.
              </p>
            </div>

            <div className="migration-faq__item">
              <h3>Регистрация через MiniApp и через веб-страницу</h3>
              <p>
                Каждое событие в Orbo имеет два способа регистрации: MiniApp для Telegram
                (максимальная конверсия для участников группы) и веб-страница с прямой ссылкой
                (для тех, кто ещё не в Telegram, или для публикации в других каналах).
                Оба способа ведут в одну базу — дублирования нет.
              </p>
            </div>
          </div>
        </div>
