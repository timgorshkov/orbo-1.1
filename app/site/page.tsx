  ...
  return (
    <>
      ...
      <section className="website-section website-section--alt">
        <div className="website-container">
          <div className="section-header section-header--center">
            <span className="section-header__eyebrow">Бот для Telegram-группы</span>
            <h2 className="section-header__title">Как Orbo работает с вашей группой</h2>
            <p className="section-header__subtitle">
              Бот для администрирования и аналитики Telegram-группы — подключается за 2 минуты
            </p>
          </div>

          <div className="migration-faq">
            <div className="migration-faq__item">
              <h3>Что делает бот для управления группой в Telegram?</h3>
              <p>
                Orbo — это бот для администрации группы в Telegram, который автоматически собирает
                статистику участников: кто пишет, кто реагирует, кто молчит. Каждый участник получает
                карточку с историей активности, контактами и посещёнными событиями. Это не конструктор
                ботов — это готовая CRM, которую не нужно программировать.
              </p>
            </div>

            <div className="migration-faq__item">
              <h3>Статистика и аналитика группы</h3>
              <p>
                Дашборд показывает активность в группе: количество сообщений, реакций,
                новых участников за период. Видите, кто самый активный, а кто давно не писал.
                Бот для статистики Telegram-группы работает автоматически — достаточно
                добавить его в группу и дать права администратора.
              </p>
            </div>

            <div className="migration-faq__item">
              <h3>Автоматические уведомления участникам</h3>
              <p>
                Orbo отправляет уведомления в личные сообщения: напоминания о событиях,
                приветственные сообщения новым участникам, анонсы в группу. Бот поддерживает
                уведомления и в Telegram, и в Max — на случай, если один из мессенджеров
                станет недоступен.
              </p>
            </div>

            <div className="migration-faq__item">
              <h3>Чем отличается от конструктора ботов?</h3>
              <p>
                Конструктор ботов для Telegram — это инструмент для создания бота с нуля:
                команды, сценарии, интеграции. Orbo — готовое решение. Не нужно настраивать
                логику, писать тексты ответов или подключать API. Добавили бота в группу —
                через минуту видите участников и статистику. Бесплатно для сообществ до 500 человек.
              </p>
            </div>

            <div className="migration-faq__item">
              <h3>CRM для Telegram-сообщества: зачем?</h3>
              <p>
                Если вы ведёте сообщество, клуб или канал — участники это ваш главный актив.
                Без CRM контакты разбросаны по чатам, история участия нигде не хранится,
                а при блокировке мессенджера вы теряете всё. Orbo собирает базу участников
                автоматически и хранит её на серверах в России, независимо от судьбы мессенджера.
              </p>
            </div>
          </div>
        </div>
