...
|----------|--------------|
| Формат | **Машиночитаемый JSON** (обязательно) |
...
После завершения вы получите папку с файлом `result.json`.
...
- Убедитесь, что используете формат **Машиночитаемый JSON** (не HTML)
