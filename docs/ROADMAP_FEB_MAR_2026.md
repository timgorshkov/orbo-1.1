...
### ✅ Что сделано (на январь 2026):
| Область | Готовность | Ключевые функции |
|---------|------------|------------------|
| **Telegram-интеграция** | 98% | 3 бота, webhook, импорт, MiniApp |
| **CRM участников** | 90% | Профили, теги, AI-обогащение, скоринг |
| **Уведомления** | 95% | AI-анализ негатива, вопросы, неактивность |
| **События** | 95% | MiniApp регистрация, оплата, напоминания |
| **Orbo Apps** | 60% | Базовые типы, коллекции (нет публичного каталога) |
| **Аналитика** | 70% | Дашборд, метрики групп, attention zones |
