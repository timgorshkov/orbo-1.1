...
> 
> Приложение использует серверную PostgreSQL через `PostgresQueryBuilder`.
> Supabase client используется только для auth fallback.
> Storage мигрирован на Selectel S3.
> 
